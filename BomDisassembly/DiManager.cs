...
using Translator;
using MenuCreationParams = SAPbouiCOM.MenuCreationParams;
...
namespace BomDisassembly
{
    class DiManager
    {
        ...
        public static void AddRightClickMenue(string activeFormTitle, string menuUnicId, string menuDescription)
        {
            if (Application.SBO_Application.Forms.ActiveForm.Title != activeFormTitle) return;
            try
            {
                MenuCreationParams oCreationPackage = (MenuCreationParams)Application.SBO_Application.CreateObject(SAPbouiCOM.BoCreatableObjectType.cot_MenuCreationParams);
                oCreationPackage.Type = SAPbouiCOM.BoMenuType.mt_STRING;
                oCreationPackage.UniqueID = menuUnicId;
                oCreationPackage.String = menuDescription;
                oCreationPackage.Enabled = true;
                SAPbouiCOM.MenuItem oMenuItem = Application.SBO_Application.Menus.Item("1280");
